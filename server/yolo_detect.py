...
def yolo_detect(
    image,
    labelsPath='./yolo_model/coco.names', 
    weightsPath = './yolo_model/yolov4-tiny.weights',
    configPath = './yolo_model/yolov4-tiny.cfg',
    yoloConfidence = 0.5,
    yoloThreshold = 0.3
    ):
...
if __name__ == '__main__':
    ...
    # 讀取照片
    imgFilePath = './yolo_model/dog.jpg'
    image = cv2.imread(imgFilePath)

    # 執行物件偵測
    outputImg = yolo_detect(
        image,
        labelsPath='./yolo_model/coco.names', 
        weightsPath = './yolo_model/yolov4-tiny.weights',
        configPath = './yolo_model/yolov4-tiny.cfg',
